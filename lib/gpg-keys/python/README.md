...
This directory contains GPG public keys used to verify Python release signatures.
...
Keys are stored in this directory and imported during build time for GPG signature verification.
...
- Download from: `https://www.python.org/ftp/python/{version}/Python-{version}.tar.gz.asc`
...
- PEP 761: Deprecating PGP signatures (Python 3.14+): https://peps.python.org/pep-0761/

## Note

Python 3.14 and later will use Sigstore signing exclusively. This GPG infrastructure supports Python versions up to 3.13.
