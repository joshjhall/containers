...
TREE_SITTER_CLI_VERSION="${TREE_SITTER_CLI_VERSION:-0.26.12}"
CARGO_WATCH_VERSION="${CARGO_WATCH_VERSION:-8.5.3}"
CARGO_EXPAND_VERSION="${CARGO_EXPAND_VERSION:-1.0.124}"
...
LLVM_COV_VERSION="${LLVM_COV_VERSION:-0.9.0}"
BACON_VERSION="${BACON_VERSION:-3.24.0}"
