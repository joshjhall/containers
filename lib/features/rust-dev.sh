...
TREE_SITTER_CLI_VERSION="${TREE_SITTER_CLI_VERSION:-0.27.0}"
CARGO_WATCH_VERSION="${CARGO_WATCH_VERSION:-8.5.3}"
CARGO_EXPAND_VERSION="${CARGO_EXPAND_VERSION:-1.0.126}"
CARGO_MODULES_VERSION="${CARGO_MODULES_VERSION:-0.27.0}"
...
NEXTEST_VERSION="${NEXTEST_VERSION:-0.9.144}"
LLVM_COV_VERSION="${LLVM_COV_VERSION:-0.9.1}"
BACON_VERSION="${BACON_VERSION:-3.25.0}"
TOKEI_VERSION="${TOKEI_VERSION:-15.0.0}"
HYPERFINE_CARGO_VERSION="${HYPERFINE_CARGO_VERSION:-1.20.0}"
JUST_CARGO_VERSION="${JUST_CARGO_VERSION:-1.58.0}"
SCCACHE_VERSION="${SCCACHE_VERSION:-0.18.0}"
MDBOOK_VERSION="${MDBOOK_VERSION:-0.5.4}"
CARGO_RELEASE_VERSION="${CARGO_RELEASE_VERSION:-1.1.5}"
TAPLO_CLI_VERSION="${TAPLO_CLI_VERSION:-0.10.0}"
MOLD_VERSION="${MOLD_VERSION:-2.42.1}"
