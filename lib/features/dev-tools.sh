...
GLAB_VERSION="${GLAB_VERSION:-1.111.0}"
...
BIOME_VERSION="${BIOME_VERSION:-2.5.6}"
...
RUMDL_VERSION="${RUMDL_VERSION:-0.2.48}"
...
DUA_VERSION="${DUA_VERSION:-2.40.1}"
...
AGNIX_VERSION="${AGNIX_VERSION:-0.45.0}"
