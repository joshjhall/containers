...
GLAB_VERSION="${GLAB_VERSION:-1.114.0}"
...
BIOME_VERSION="${BIOME_VERSION:-2.5.10}"
...
RUMDL_VERSION="${RUMDL_VERSION:-0.2.60}"
...
DUA_VERSION="${DUA_VERSION:-2.43.0}"
HYPERFINE_VERSION="${HYPERFINE_VERSION:-1.20.0}"
VALE_VERSION="${VALE_VERSION:-3.18.0}"
TYPOS_VERSION="${TYPOS_VERSION:-1.49.0}"
...
AGNIX_VERSION="${AGNIX_VERSION:-0.49.0}"
