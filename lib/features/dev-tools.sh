...
GLAB_VERSION="${GLAB_VERSION:-1.115.0}"
...
BIOME_VERSION="${BIOME_VERSION:-2.5.11}"
...
RUMDL_VERSION="${RUMDL_VERSION:-0.2.62}"
DPRINT_VERSION="${DPRINT_VERSION:-0.56.1}"
OSV_SCANNER_VERSION="${OSV_SCANNER_VERSION:-2.5.1}"
YQ_VERSION="${YQ_VERSION:-4.53.6}"
SD_VERSION="${SD_VERSION:-1.1.0}"
DUA_VERSION="${DUA_VERSION:-2.43.1}"
HYPERFINE_VERSION="${HYPERFINE_VERSION:-1.20.0}"
VALE_VERSION="${VALE_VERSION:-3.19.0}"
TYPOS_VERSION="${TYPOS_VERSION:-1.50.0}"
SHFMT_VERSION="${SHFMT_VERSION:-3.14.0}"
...
AGNIX_VERSION="${AGNIX_VERSION:-0.52.1}"
