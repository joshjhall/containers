...
GLAB_VERSION="${GLAB_VERSION:-1.106.0}"
...
BIOME_VERSION="${BIOME_VERSION:-2.5.2}"
...
RUMDL_VERSION="${RUMDL_VERSION:-0.2.28}"
DPRINT_VERSION="${DPRINT_VERSION:-0.55.1}"
OSV_SCANNER_VERSION="${OSV_SCANNER_VERSION:-2.4.0}"
YQ_VERSION="${YQ_VERSION:-4.53.3}"
SD_VERSION="${SD_VERSION:-1.1.0}"
DUA_VERSION="${DUA_VERSION:-2.37.1}"
HYPERFINE_VERSION="${HYPERFINE_VERSION:-1.20.0}"
VALE_VERSION="${VALE_VERSION:-3.15.1}"
TYPOS_VERSION="${TYPOS_VERSION:-1.48.0}"
...
CODEGRAPH_VERSION="${CODEGRAPH_VERSION:-1.2.0}"
