...
GLAB_VERSION="${GLAB_VERSION:-1.116.0}"
LAZYGIT_VERSION="${LAZYGIT_VERSION:-0.65.0}"
DELTA_VERSION="${DELTA_VERSION:-0.19.2}"
ACT_VERSION="${ACT_VERSION:-0.2.89}"
GITCLIFF_VERSION="${GITCLIFF_VERSION:-2.8.0}"
BIOME_VERSION="${BIOME_VERSION:-2.5.12}"
...
LEFTHOOK_VERSION="${LEFTHOOK_VERSION:-2.1.12}"
GITLEAKS_VERSION="${GITLEAKS_VERSION:-8.30.1}"
RUMDL_VERSION="${RUMDL_VERSION:-0.2.68}"
DPRINT_VERSION="${DPRINT_VERSION:-0.57.4}"
OSV_SCANNER_VERSION="${OSV_SCANNER_VERSION:-2.5.1}"
YQ_VERSION="${YQ_VERSION:-4.53.6}"
SD_VERSION="${SD_VERSION:-1.1.0}"
DUA_VERSION="${DUA_VERSION:-2.44.0}"
HYPERFINE_VERSION="${HYPERFINE_VERSION:-1.20.0}"
VALE_VERSION="${VALE_VERSION:-3.20.0}"
TYPOS_VERSION="${TYPOS_VERSION:-1.50.1}"
...
AGNIX_VERSION="${AGNIX_VERSION:-0.52.2}"
