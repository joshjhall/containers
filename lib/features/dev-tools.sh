...
GLAB_VERSION="${GLAB_VERSION:-1.112.0}"
...
RUMDL_VERSION="${RUMDL_VERSION:-0.2.52}"
DPRINT_VERSION="${DPRINT_VERSION:-0.55.2}"
OSV_SCANNER_VERSION="${OSV_SCANNER_VERSION:-2.5.0}"
YQ_VERSION="${YQ_VERSION:-4.53.3}"
SD_VERSION="${SD_VERSION:-1.1.0}"
DUA_VERSION="${DUA_VERSION:-2.41.1}"
HYPERFINE_VERSION="${HYPERFINE_VERSION:-1.20.0}"
VALE_VERSION="${VALE_VERSION:-3.17.1}"
...
AGNIX_VERSION="${AGNIX_VERSION:-0.47.0}"
