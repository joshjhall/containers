...
GLAB_VERSION="${GLAB_VERSION:-1.117.0}"
LAZYGIT_VERSION="${LAZYGIT_VERSION:-0.65.1}"
DELTA_VERSION="${DELTA_VERSION:-0.19.2}"
ACT_VERSION="${ACT_VERSION:-0.2.89}"
GITCLIFF_VERSION="${GITCLIFF_VERSION:-2.8.0}"
BIOME_VERSION="${BIOME_VERSION:-2.5.13}"
...
RUMDL_VERSION="${RUMDL_VERSION:-0.2.73}"
...
DUA_VERSION="${DUA_VERSION:-2.45.0}"
