...
BIOME_VERSION="${BIOME_VERSION:-2.5.14}"
...
LEFTHOOK_VERSION="${LEFTHOOK_VERSION:-2.1.14}"
...
TYPOS_VERSION="${TYPOS_VERSION:-1.50.2}"
...
AGNIX_VERSION="${AGNIX_VERSION:-0.54.0}"
