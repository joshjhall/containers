...
write_bashrc_content /etc/bashrc.d/50-kotlin.sh "Kotlin environment configuration" << 'KOTLIN_BASHRC_EOF'
# ----------------------------------------------------------------------------
...
write_bashrc_content /etc/bashrc.d/50-kotlin.sh "Kotlin aliases and helpers" << 'KOTLIN_BASHRC_EOF'
