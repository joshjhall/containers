...
write_bashrc_content /etc/bashrc.d/50-android.sh "Android SDK environment configuration" << 'ANDROID_BASHRC_EOF'
# ----------------------------------------------------------------------------
...
write_bashrc_content /etc/bashrc.d/50-android.sh "Android aliases and helpers" << 'ANDROID_BASHRC_EOF'
