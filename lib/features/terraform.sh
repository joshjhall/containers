...
TERRAGRUNT_VERSION="${TERRAGRUNT_VERSION:-1.0.3}"
TFDOCS_VERSION="${TFDOCS_VERSION:-0.22.0}"
TFLINT_VERSION="${TFLINT_VERSION:-0.62.0}"
...
log_feature_instructions "test-terraform" "terraform"
