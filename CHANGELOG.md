...
- Bump librarian to v0.8.4 (#776)

## [4.19.21] - 2026-08-02

### Miscellaneous

- Automated version updates to v4.19.21

## [4.19.20] - 2026-07-26

### Miscellaneous

- Automated version updates to v4.19.20
...
- Port add and remove feature commands (#687)

### Miscellaneous

- Symlink .codegraph to /cache/codegraph
- Bump librarian marketplace pin to v0.5.0
...
- Catalog-aware version bump via `catalog add-version` (#507)
- Dispatch luggage evidence runs for bumped tools (#506 Phase 2) (#509)
...
- Add typos spell checker (Rust static binary)
...
- Fix manual_assert and single-item into_iter lints

## [4.16.1] - 2026-04-12

### Miscellaneous

- Automated version updates to v4.16.1
- Update compatibility matrix with passing test results
- Update compatibility matrix with passing test results
- Update compatibility matrix with passing test results
- Update compatibility matrix with passing test results
...
- Fix skills count and stale version entries
...
[4.19.20]: https://github.com/joshjhall/containers/compare/v4.19.19...v4.19.20
