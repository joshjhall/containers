...
1. **Dockerfile** - Version comment at the top
1. **tests/framework.sh** - Test framework version constant
1. **CHANGELOG.md** - Generated from git commits (unless `--skip-changelog`)
