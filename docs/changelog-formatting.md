...
This document explains how the CHANGELOG.md is automatically generated and how to write commits that produce useful changelog entries.

## Overview

The CHANGELOG.md is automatically generated using [git-cliff](https://git-cliff.org/) based on conventional commit messages. The `bin/release.sh` script regenerates it on each release.
...
**Special cases:**
- `chore(release):` commits are automatically **skipped** (not shown in CHANGELOG)
...
❌ Use vague messages like "Fix stuff" or "Update files"
❌ Mix unrelated changes in one commit
❌ Skip the type prefix (`feat:`, `fix:`, etc.)
