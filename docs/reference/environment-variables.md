...
| `LIBRARIAN_REF`      | `v0.8.4`  | Pinned **signed release tag** (v0.4.0+) of the librarian plugin marketplace; the build fetches the signed release tarball and verifies it with cosign before installing to `/opt/librarian` (fail-closed, #671) |
