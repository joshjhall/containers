...
# Compatibility matrix file (used by sourced matrix-update.sh library)
export MATRIX_FILE="$PROJECT_ROOT/version-compatibility-matrix.json"

# Source extracted library modules
source "${SCRIPT_DIR}/lib/test-version-compat/matrix-update.sh"
