...
- [git flags need the Debian 11 floor](git-flags-need-debian-11-floor.md) — Bullseye ships git 2.30.2; a newer flag behind a `|| return 0` fail-safe no-ops the whole feature silently (#884)
